...
const TodoCard = ({ todo }: TTodoCardProps) => {
    const { title, description, isCompleted, priority, _id } = todo
    ...
    return (
        <div className="flex justify-between items-center bg-white p-2 rounded-md border" >
            <input className="mr-3" onChange={handleToggle} checked={isCompleted} type="checkbox" name="complete" id="complete" />
